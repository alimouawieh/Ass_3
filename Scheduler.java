...
/*RESOURCES AND REFERENCES: import java.io.BufferedReader;
import java.io.BufferedWriter;
import java.io.File;
import java.io.FileNotFoundException;
import java.io.FileReader;
 ...
 */
	...
	public void CheckTextFile() //will take String to check it in the text file 
	{
		...
		for (String line : Files.readAllLines(Paths.get("C:/Users/Ali/workspace/OSAss2Write/wawanesa.txt"))) { //change to location of the text file we wanna put in
